...
Visual authoring tool for the **synth** modular synthesizer platform. Drag-and-drop
composition of pipeline items, wiring typed ports together; runs pipelines locally and
pushes them to remote headless instances over the LAN.
